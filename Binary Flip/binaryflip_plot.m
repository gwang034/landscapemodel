function binaryflip_plot(paramaux, xmintraj, xmaxtraj, ymintraj, ymaxtraj)
...
%% Find Critical Points
allattractors = binaryflip_eq(paramaux(1), paramaux(2));
...
title("Binary Flip - Saddle Point Level Curves")
